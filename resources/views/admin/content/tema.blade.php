            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        <!-- /.card-header -->
                        <div class="card-body">
                            <a href="{{ url('dashboard/tema/create') }}" class="btn btn-outline-dark"><i
                                    class="fas fa-plus"></i>
                                Create</a>
                            <br>
                            <br>
                                    ...
                                    @foreach ($data as $item)
                                        <tr>
                                            ...
                                            <td class="d-flex justify-content-center">
                                                <a href="{{ url('dashboard/tema/' . $item->tema_id) }}"
                                                    class="btn btn-sm btn-warning" style="margin-right: 5px"><i
                                                        class="fas fa-pen" style="color: white"></i></a>
                                                <form action="{{ url('dashboard/tema/' . $item->tema_id) }}" method="POST">
                                                    @method('DELETE')
                                                    @csrf
